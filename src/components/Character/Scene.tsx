...
const Scene = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error("WebGL is unavailable. Showing the portfolio without the 3D character.", error);
      setLoading(100);
      return;
    }
    ...
    // Never trap visitors on the loading screen if a large 3D asset is slow or blocked.
    const loadingSafetyTimer = window.setTimeout(() => progress.clear(), 15000);
